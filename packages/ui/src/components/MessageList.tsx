  ...
  return (
    ...
    >
      ...
      {segments.map((seg, idx) => {
        ...
        if (seg.kind === "user") {
          return (
            <div key={`user-${seg.msgIdx}`} className="md:ml-12">
        ...
        if (seg.kind === "assistant-text") {
          return (
            <div key={`atext-${seg.msgIdx}-${seg.block.originalIndex}`} className="md:mr-12">
        ...
        if (seg.kind === "assistant-error") {
          ...
          return (
            <div
              key={`aerr-${seg.msgIdx}-${err.originalIndex}`}
              className="md:mr-12 mt-2 px-3 py-2 text-sm bg-red-50 border border-red-200 rounded-md"
            >
